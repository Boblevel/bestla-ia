...
test('generervideo utilise MiniMax H3 via Gradio officiel sans secours image locale pour le texte', async () => {
  ...
  assert.match(media, /const fallback = \[prompt, null, null, this\.videoCanvas\(\), 5, 28, 42, true\]/)
